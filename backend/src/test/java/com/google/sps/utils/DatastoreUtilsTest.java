...
public class DatastoreUtilsTest {
  ...
  public void testGetExistingUserEntity() {
    Entity expectedUser = TestUtils.getUserEntityWithDietsOnly();
    datastore.put(expectedUser);

    Entity actualUser = DatastoreUtils.getUserEntity(userService);
  ...
  @Test
  public void testGetExistingPropertyAsList() {
    Entity user = TestUtils.getUserEntityWithDietsOnly();
    List<String> expectedDiets = TestUtils.DIETS;
    List<String> actualDiets = DatastoreUtils.getPropertyAsList(user, UserConstants.PROPERTY_DIETS);
  ...
  public void testGetNonExistingPropertyAsList() {
    ...
    List<String> expectedDiets = Collections.emptyList();
    List<String> actualDiets = DatastoreUtils.getPropertyAsList(user, UserConstants.PROPERTY_DIETS);
    assertEquals(expectedDiets, actualDiets);
  }
}
